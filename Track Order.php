...
<div class="track-order-container">
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div class='order-id'>Order ID: " . htmlspecialchars($row['TrackOrderID']) . "</div>";
            echo "<div class='product-name'>" . htmlspecialchars($row['ProductName']) . "</div>";
            echo "<div class='quantity'>Quantity: " . htmlspecialchars($row['Quantity']) . "</div>";
            echo "<div class='price'>Price: $" . htmlspecialchars($row['Price']) . "</div>";
            echo "<div class='total-price'>Total Price: $" . htmlspecialchars($row['TotalPrice']) . "</div>";
            echo "<div class='status'>Status: " . htmlspecialchars($row['Status']) . "</div>";
            echo "<div class='expected-delivery'>Expected Delivery: " . htmlspecialchars($row['ExpectedDelivery']) . "</div>";
            echo "<div class='order-date'>Order Date: " . htmlspecialchars($row['OrderDate']) . "</div>";
            echo "</div>"; 
        }
    } else {
