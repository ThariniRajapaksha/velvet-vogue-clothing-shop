...
$query = "SELECT * FROM category WHERE GenderID = 2 AND CategoryID IN (20, 22)";
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Women Formal Wear.css">
    ...
    <div class="category-cards">
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <div class="category-card">
                ...
                <a href="product_info_women_formal.php?category_id=<?php echo $row['CategoryID']; ?>" class="view-btn"><i class="fa-regular fa-eye"></i>  View</a>
            </div>
        <?php } ?>
    </div>
</section><br><br>
