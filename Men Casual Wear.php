...
$query = "SELECT * FROM category WHERE GenderID = 1 AND CategoryID IN (1, 3, 6, 8, 10, 11, 13, 15, 17)";
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Men Casual Wear.css">
    ...
    <div class="category-cards">
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <div class="category-card">
                ...
                <a href="product_info_men_casual.php?category_id=<?php echo $row['CategoryID']; ?>" class="view-btn"><i class="fa-regular fa-eye"></i>  View</a>
            </div>
        <?php } ?>
    </div>
</section><br><br>
