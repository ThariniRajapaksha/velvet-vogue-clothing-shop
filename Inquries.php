    ...
    <div class="inquiry-container">
        <div class="inquiry-content">
            <div class="inquiry-image">
                <img src="Images/Inqury.webp" alt="Velvet Vogue Inquiry" class="inquiry-img">
            </div>
            <div class="inquiry-form-container">
                ...
                <form class="inquiry-form" action="submit_inquiry.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="subject" name="subject" placeholder="Enter your type of inqury" required>
                    </div>

                    <div class="form-group">
                        <label for="message">Inqury</label>
                        <textarea id="message" name="message" rows="5" placeholder="Enter your inqury" required></textarea>
                    </div>
